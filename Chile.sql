...
--
-- Servidor: localhost
-- Tiempo de generación: 16-06-2017 a las 16:45:07
...
CREATE TABLE `Comunas` (
  `id_comuna` int(11) NOT NULL COMMENT 'ID unico de la comuna',
  `id_provincia1` int(11) NOT NULL COMMENT 'ID de la provincia asociada',
  `nom_comuna` varchar(30) COLLATE latin1_spanish_ci DEFAULT NULL COMMENT 'Nombre descriptivo de la comuna'
...
INSERT INTO `Comunas` (`id_comuna`, `id_provincia1`, `nom_comuna`) VALUES
(1, 1, 'ARICA'),
(2, 1, 'CAMARONES'),
(3, 2, 'PUTRE'),
(4, 2, 'GENERAL LAGOS'),
...
CREATE TABLE `Provincias` (
  ...
  `id_region1` int(11) NOT NULL COMMENT 'ID region asociada',
  `nom_provincia` varchar(30) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Nombre descriptivo',
...
INSERT INTO `Provincias` (`id_provincia`, `id_region1`, `nom_provincia`, `num_comunas`) VALUES
(1, 1, 'ARICA', 2),
(2, 1, 'PARINACOTA', 2),
(3, 2, 'IQUIQUE', 2),
(4, 2, 'TAMARUGAL', 5),
...
CREATE TABLE `Regiones` (
  `id_region` int(11) NOT NULL COMMENT 'ID unico',
  `nom_region` varchar(60) COLLATE latin1_spanish_ci NOT NULL COMMENT 'Nombre extenso',
...
INSERT INTO `Regiones` (`id_region`, `nom_region`, `str_romano`, `num_provincias`, `num_comunas`) VALUES
...
--
ALTER TABLE `Comunas`
  ADD PRIMARY KEY (`id_comuna`,`id_provincia1`);
...
--
ALTER TABLE `Comunas`
  MODIFY `id_comuna` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID unico de la comuna', AUTO_INCREMENT=347;
